...
const SDK_FILE = path_1.default.join(process.cwd(), '.api/apis/dtone/index.ts');
const CORE_FILE = path_1.default.join(process.cwd(), 'node_modules', 'api', 'dist', 'core', 'index.js');
// 1. Patch the generated SDK file
if (fs_1.default.existsSync(SDK_FILE)) {
    console.log(`[Fix-SDK] 🔧 Patching SDK: ${SDK_FILE}...`);
    let content = fs_1.default.readFileSync(SDK_FILE, 'utf8');
...
if (fs_1.default.existsSync(CORE_FILE)) {
    ...
    let coreContent = fs_1.default.readFileSync(CORE_FILE, 'utf8');
